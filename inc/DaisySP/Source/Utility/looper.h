...
class Looper
{
  public:
    ...
    */
    ...
    inline bool RecordingQueued() const { return rec_queue_; }
  ...
  private:
    /** Constants */
    static constexpr float kFripDecayVal      = 0.70710678118f;
    ...
    inline float Read(size_t pos) const { return buff_[pos]; }
